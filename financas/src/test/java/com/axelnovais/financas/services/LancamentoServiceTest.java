...
import com.axelnovais.financas.model.repository.LancamentoRepositoryTest;
import com.axelnovais.financas.services.impl.LancamentoServiceImpl;
...
public class LancamentoServiceTest {
    ...
    public void naoDeveSalvarUmLancamentoQuandoHouverErroDeValidacao() {
        //cenário
        Lancamento lancamentoASalvar = LancamentoRepositoryTest.criarLancamento();
        doThrow( RegraDeNogocioException.class ).when(service).validar(lancamentoASalvar);

        //execucao e verificacao
        catchThrowableOfType( () -> service.salvar(lancamentoASalvar), RegraDeNogocioException.class );
    ...
    public void deveLancarErrosAoValidarUmLancamento() {
        ...
        assertThat(erro).isInstanceOf(RegraDeNogocioException.class).hasMessage("Informe uma Descrição válida.");
        ...
        erro = Assertions.catchThrowable( () -> service.validar(lancamento) );
        assertThat(erro).isInstanceOf(RegraDeNogocioException.class).hasMessage("Informe um Mês válido.");
        ...
        erro = catchThrowable( () -> service.validar(lancamento) );
        assertThat(erro).isInstanceOf(RegraDeNogocioException.class).hasMessage("Informe um Ano válido.");
        ...
        erro = catchThrowable( () -> service.validar(lancamento) );
        assertThat(erro).isInstanceOf(RegraDeNogocioException.class).hasMessage("Informe um Usuário.");
        ...
        erro = catchThrowable( () -> service.validar(lancamento) );
        assertThat(erro).isInstanceOf(RegraDeNogocioException.class).hasMessage("Informe um Valor válido.");
        ...
        erro = catchThrowable( () -> service.validar(lancamento) );
        assertThat(erro).isInstanceOf(RegraDeNogocioException.class).hasMessage("Informe um tipo de Lançamento.");
